...
def explain_prediction(probability, input_dict, surname):
  ...
  layman's terms. For example: instead of saying NumOfProducts, just say number of 
...
def generate_email(probability, input_dict, explanation, surname):
  ...
  List the incentives in an appropriate markdown bullet point format.
  ...
  **Instructions for Bullet Points:**
  ...
  You can end it with my name, Abdullah Naveed on a new line.
  """
...
if selected_customer_option:
    ...
    with col2:
        ...
        num_products = st.number_input("Number of Products", min_value=0,
                                       max_value=10,
